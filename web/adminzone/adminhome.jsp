    ...
    <body bgcolor="lightblue">
      <div id="outer">  
          ...
          <div id="menu">
           ...
           <div id="main">
               <form action="admincode/addnotification.jsp" method="post">
               ...
               <table style="margin: 0px auto; width:70%" border="1">
                   <tr>
                       ...
                       <td><textarea name="notificationtext" required="" style="margin:0px; width:339px;height:45px; resize:none;"></textarea></td>
                   </tr>    
                   <tr>
        ...
        while(rs.next())
                {
                  ...
                  <tr>
                      ...
                      <td>
                          <a href="admincode/deletenotification.jsp?id=<%=rs.getInt("id")%>">Delete</a>
                      </td>
                  </tr>
                  <% } %>
